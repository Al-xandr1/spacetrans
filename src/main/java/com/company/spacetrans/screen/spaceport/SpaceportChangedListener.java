...
public class SpaceportChangedListener {
    ...
    public SpaceportChangedListener(@NotNull DataManager dataManager, @NotNull SpaceportService spaceportService) {
    ...
    @EventListener
    public void spaceportChanged(@NotNull EntityChangedEvent<Spaceport> event) {
